export const site = {
  ...
  phone: "+7 977 363-93-00",
  phoneHref: "tel:+79773639300",
  telegram: "https://t.me/puholet",
  telegramLabel: "@puholet",
  maxUrl: "https://max.ru/",
  location: {
  ...
  maps: {
    yandex:
      "https://yandex.ru/maps/?text=%D1%80%D0%B0%D0%B9%D0%BE%D0%BD+%D0%9E%D1%87%D0%B0%D0%BA%D0%BE%D0%B2%D0%BE-%D0%9C%D0%B0%D1%82%D0%B2%D0%B5%D0%B5%D0%B2%D1%81%D0%BA%D0%BE%D0%B5%2C+%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0",
    google:
      "https://www.google.com/maps/search/?api=1&query=%D0%9E%D1%87%D0%B0%D0%BA%D0%BE%D0%B2%D0%BE-%D0%9C%D0%B0%D1%82%D0%B2%D0%B5%D0%B5%D0%B2%D1%81%D0%BA%D0%BE%D0%B5+%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0",
  },
  stats: [
    { value: "20+", label: { ru: "лет в ИТ", en: "years in IT" } },
    { value: "8", label: { ru: "продакшн-команд", en: "production teams" } },
    { value: "60+", label: { ru: "чел. в командах", en: "people in teams" } },
    { value: "30K+", label: { ru: "польз./день", en: "users/day" } },
    { value: "300M", label: { ru: "портфель ₽/год", en: "portfolio ₽/yr" } },
    { value: "5K+", label: { ru: "заявок/мес", en: "requests/mo" } },
  ],
  about: {
    intro: {
      ru: "Личность · Опыт · Бизнес",
      en: "Identity · Experience · Business",
    },
    education: {
      ru: [
        "ВА РВСН — 5 лет, ВМКСиС, инженер",
        "ВАВТ — 3,5 года, финансы и кредит, экономист-международник",
      ],
      en: [
        "SRF Military Academy — 5 years, computing systems and networks, engineer",
        "Foreign Trade Academy — 3.5 years, finance and credit, international economist",
      ],
    },
    focus: {
  ...
  cases: [
    ...
    {
      title: {
        ru: "Контроль превышений план/факт",
        en: "Plan-vs-actual overrun control",
      },
      meta: {
        ru: "PMO-аналитика · люди и задачи · еженедельный цикл",
        en: "PMO analytics · people and tasks · weekly cycle",
      },
      summary: {
        ru: "Методология и tooling: конвейер Plan-Fact × Jira, язык контроля ФИО × период, точечные разборы без ручного перебора недель.",
        en: "Methodology and tooling: Plan-Fact × Jira pipeline, person × period control language, targeted reviews.",
      },
      href: "https://puholet-sketch.github.io/PlanFact/",
      cta: { ru: "Открыть демо", en: "Open demo" },
    },
    {
      title: {
        ru: "Ежемесячный статус портфеля",
        en: "Monthly portfolio status",
      },
      meta: {
        ru: "Регулярный дайджест для руководства",
        en: "Regular leadership digest",
      },
      summary: {
        ru: "Один интерактивный дайджест: СК, команды, поставки, ТП и матрица PM — без разрозненных таблиц.",
        en: "One interactive digest: insurers, teams, deliveries, support, and PM matrix.",
      },
      href: "https://puholet-sketch.github.io/virtu-digest-may-2026/",
      cta: { ru: "Открыть дайджест", en: "Open digest" },
    },
    {
      title: {
  ...
  projects: [
    ...
    },
    {
      title: "ОУД4",
      text: {
        ru: "Лендинг по оценке доверия (ГОСТ Р ИСО/МЭК 15408): 8 этапов и пакет документов.",
        en: "Trust evaluation landing (GOST R ISO/IEC 15408): 8 stages and document pack.",
      },
      href: "https://puholet-sketch.github.io/oud4-consulting/",
    },
    {
      title: "DDX Coach",
      text: {
        ru: "Дневник тренировок: план Пн–Пт, вес/повторы, анатомия, прогресс.",
    ...
    },
    {
      title: "Шлагбаум.Путь",
      text: {
        ru: "Гид по установке шлагбаума во дворе Москвы: этапы, чек-листы, АМПП / ЭД.",
        en: "Moscow courtyard barrier guide: stages, checklists, AMPP / Electronic Home.",
      },
      href: "https://puholet-sketch.github.io/shlagbaum-put/",
    },
    {
      title: "IntroAI",
      text: {
        ru: "Короткий гайд по AI для нетехнарей: старт, практика, Cursor, маршрут на 4 недели.",
